...
public class MyBlogDetailsActivity extends AppCompatActivity implements MyBlogsView {
    ...
    MyBlogsPresenter blogsPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        blogsPresenter = new MyBlogPresenterImpl();
        setFont();
    ...
    public void getBlogDetailsSuccessfull(ArrayList<MyDetailsBlogsModel.BlogList> blogLists) {
        ...
        String userName = blogLists.get(0).getBlogTitle();
